...
(function($){
	//default properties.
	var a=/a/i,defs={
		item:'a',next:'<img src=\"/images/btn_paging_next.png\"  width=\"13\" height=\"13\" class=\"valign_mid\" />',prev:'<img src=\"/images/btn_paging_prev.png\" width=\"13\" height=\"13\" class=\"valign_mid\"/>',format:'{0}',
		itemClass:'paging-item',sideClass:'paging-side',
		itemCurrent:'selected',length:10,max:1,current:1,append:false
		,href:'#{0}',event:true,first:'<img src\="/images/btn_paging_first.png\" width=\"13\" height=\"13\" class=\"valign_mid\"/>',last:'<img src=\"/images/btn_paging_end.png\" width=\"13\" height=\"13\" class=\"valign_mid\"/>'
	},format=function(str){
		var arg=arguments;
