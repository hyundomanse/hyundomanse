 ...
 *    |_ AbstractDAO.java
 * 
 * @comment: Spring 의 iBatis 연동 지원을 Annotation 형식으로 쉽게 처리하기 위한 공통 parent DAO 클래스
 * @date   : 2015. 11. 17. 오후 11:21:44
 * @version: 1.0 
 * @author : j2dev 
 */
...
public class AbstractDAO extends SqlMapClientDaoSupport {
     ...
     *        - 입력 처리 SQL mapping 입력 데이터를 세팅한 파라메터
     *        객체(보통 VO 또는 Map)
     * 쿼리 commit은 Transaction 처리 함
     * 
     */
    public void insertTran(String queryId, Object parameterObject) throws SQLException{
			this.getSqlMapClient().insert(queryId, parameterObject);
    }
    /**
     ...
     * 
     */
    public void updateTran(String queryId, Object parameterObject) throws SQLException{
			this.getSqlMapClient().update(queryId, parameterObject);
    }
    /**
     ...
     * @throws SQLException 
     */
    public void deleteTran(String queryId, Object parameterObject) throws SQLException {
         this.getSqlMapClient().delete(queryId, parameterObject);
    }
    /**
